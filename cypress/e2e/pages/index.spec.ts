context("/ on macbook-16", () => {
  ...
  it("should have Homepage slider cards", () => {
  ...
  it("should have comparison section", () => {
    cy.findByTestId("SolutionSection").within(() => {
      cy.findByTestId("title")
        .should("be.visible")
        .should("have.text", "The Post-Fintech Revolution");
      cy.findByTestId("desc")
        .should("be.visible")
        .should(
          "have.text",
  ...
  it("should have Benefits section", () => {
    cy.findByTestId("BenefitSection").within(() => {
      cy.findByTestId("Benefits.title")
        .should("be.visible")
        .should("have.text", "Benefits of DeFiChain.");
  ...
  it("should have FunctionsSection", () => {
    cy.findByTestId("FunctionsSection").within(() => {
      cy.findByTestId("Design.title")
        .should("be.visible")
        .should(
          "have.text",
  ...
  it("should have BuiltOnBitcoinSection", () => {
    cy.findByTestId("BuiltOnBitcoinSection").within(() => {
      cy.findByTestId("title")
        .should("be.visible")
        .should("have.text", "Built-on-bitcoin");
      cy.findByTestId("desc")
        .should("be.visible")
        .should(
          "have.text",
  ...
  it("should have distribution section", () => {
    cy.findByTestId("DistributionSection").within(() => {
      cy.findByTestId("Nodes.Title")
        .should("be.visible")
        .should("have.text", "Decentralized and distributed");
      cy.findByTestId("Nodes.Desc")
        .should("be.visible")
        .should(
          "have.text",
  ...
  it("should have roadmap section", () => {
    cy.findByTestId("RoadmapSection")
      .should("be.visible")
      .within(() => {
        cy.findByTestId("RoadmapSection.Title")
          .should("be.visible")
...
context("/ on iphone-x", () => {
  ...
  it("should have SolutionSection", () => {
    cy.findByTestId("SolutionSection").within(() => {
      cy.findByTestId("title")
        .should("be.visible")
        .should("have.text", "The Post-Fintech Revolution");
