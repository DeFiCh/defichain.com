...
- Bei der Verwendung von Turing-completen Befehlssätzen müssen Programmierer komplexe Programme erstellen, um jede Art von Anwendung zu entwickeln. Um beispielsweise einen Peer-to-Peer-Darlehensvertrag auf der Grundlage von MakerDAO zu erstellen, benötigt ein Programmierer etwa 2000 Zeilen Code. Jeder Fehler in diesem Code kann zum Verlust des Geldes oder zu anderen Konsequenzen führen. Die Pflege einer so großen Codebasis bedeutet zwangsläufig eine größere Fehleranfälligkeit und eine große Angriffsfläche selbst für einfache Anwendungen.
