context('/ecosystem page on desktop', () => {
  ...
  it('should have contribute section', function () {
    ...
    cy.findByTestId('EcosystemSection.BDeveloper').should('be.visible')
    cy.findByTestId('EcosystemSection.BPartnering').should('be.visible')
  })
  ...
  it('should have partners section', function () {
    ...
    cy.findByTestId('EcosystemSection.Coinpedia').should('be.visible')
