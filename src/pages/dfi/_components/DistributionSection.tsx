...
export function DistributionSection(): JSX.Element {
  ...
  return (
    <Container>
      <Section
        title={t("DistributionSection.title")}
        testId="DistributionSection"
      >
        <div className="text-xl" data-testid="DistributionSection.Text">
          {t("DistributionSection.desc")}
        </div>
        <div
          className="mx-auto w-full lg:w-3/5 space-y-16 mt-14"
          data-testid="DistributionSection.Chart"
        >
          <ChartSupply
            ...
            <Trans
              ...
              components={[
                <ExternalLink
                  ...
                  url="https://defiscan.live/transactions/c519fa1af8185186528dbfd5003e2ee110eae2f847b8d6143af220de6c837478"
                />,
                <ExternalLink
                  key="1"
                  className="text-primary-500"
                  url="https://github.com/DeFiCh/dfips/issues/17"
                />,
              ]}
            />
          </div>
...
function ChartSupply(props: {
  ...
  return (
    <>
      <div className="w-full h-2 relative">
        <div className="w-full h-8 relative text-gray-500 text-xl">
          <div className="w-[49%] left-0 absolute flex justify-center items-center">
            <span className="inline-block px-2 bg-white relative z-[1000]">
              49%
            </span>
      ...
      <div
        className={classNames("w-full h-[69px] relative leading-[2.4rem]", {
          "divide-x": props.fill,
        })}
      >
        ...
        <div
          className={classNames(
            "w-[51%] h-full left-[49%] absolute flex justify-center items-center rounded-bl rounded-br ",
...
function ChartDistribution(props: {
  fill?: boolean;
  labelA: string;
  labelB: string;
  labelC: string;
  ...
  return (
    <>
      ...
      <div
        className={classNames("w-full h-[69px] relative", {
          "divide-x": props.fill,
        })}
      >
        <div className="w-[26%] h-full absolute left-0 flex items-center justify-center rounded-tl rounded-bl bg-primary-500 text-white">
          {props.labelA}
        </div>
        <div
          className={classNames(
            "w-[27%] h-full left-[26%] absolute flex justify-center items-center rounded-bl rounded-br ",
            props.fill !== undefined
              ? "bg-primary-500 text-white"
              : "bg-gray-200 text-black "
          )}
        ...
        <div
          className={classNames(
            "w-[47%] h-full left-[53%] absolute flex justify-center items-center rounded-bl rounded-br ",
            props.fill !== undefined
              ? "bg-primary-500 text-white"
              : "bg-gray-200 text-black "
          )}
