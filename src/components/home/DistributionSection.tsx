...
export function DistributionSection (): JSX.Element {
  return (
    <section className='py-20' data-testid='DistributionSection'>
      <Container>
        <div className='flex flex-wrap md:flex-nowrap space-y-6 md:space-y-0 md:space-x-28 py-20'>
          <div className='flex flex-col space-y-4 md:space-y-8 items-start ' data-testid='DistributionSection.BuiltOnBitcoin'>
            <h1 className='text-3xl md:text-5xl font-semibold' data-testid='title'>Built-on-bitcoin</h1>
        ...
        <div className='py-20' data-testid='DistributionSection.Nodes'>
          <div className='flex flex-col space-y-12'>
            <h1 className='text-3xl md:text-5xl font-semibold' data-testid='Nodes.Title'>Decentralized and distributed</h1>
            <div className='text-lg md:text-2xl font-light  w-full md:w-1/2' data-testid='Nodes.Desc'>DeFiChain nodes are distributed globally across datacenters in the US, Canada, Europe, India, Singapore and Australia.</div>
          </div>
