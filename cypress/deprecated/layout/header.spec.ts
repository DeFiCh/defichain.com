context("<Header/> on desktop", () => {
  ...
  it("should have header nav items", () => {
    cy.findByTestId("DesktopNavbar").within(() => {
      cy.findByTestId("Desktop.HeaderLink.DFI")
        .should("be.visible")
        .should("have.attr", "href", "/dfi");
      cy.findByTestId("Desktop.HeaderLink.DEX")
        .should("be.visible")
        .should("have.attr", "href", "/dex");
      cy.findByTestId("Desktop.HeaderLink.Developers")
        .should("be.visible")
...
context("<Header/> on mobile", () => {
  ...
  it("should Hamburger menu icon ", () => {
    cy.findByTestId("Header.OpenMenu").should("be.visible");
  });

  it("should Hamburger close icon ", () => {
    cy.findByTestId("Header.OpenMenu")
      .click()
      .then(() => {
    ...
    cy.findByTestId("Header.OpenMenu")
      ...
      .then(() => {
        cy.findByTestId("MobileMenu").within(() => {
          cy.findByTestId("Mobile.HeaderLink.DFI")
            .should("be.visible")
            .should("have.attr", "href", "/dfi");
          cy.findByTestId("Mobile.HeaderLink.DEX")
            .should("be.visible")
            .should("have.attr", "href", "/dex");
          cy.findByTestId("Mobile.HeaderLink.Developers")
            .should("be.visible")
            .should("have.attr", "href", "/developers");
