        ...
        <div className='mt-10 flex flex-wrap space-y-8 xl:space-y-0'>
          ...
          <div className='flex flex-wrap w-full lg:w-1/2 xl:w-1/3 mx-auto lg:mx-0 xl:ml-auto space-y-6'>
            <div className='w-full'>
              ...
              <div className='coinmarketcap-currency-widget' data-currencyid='5804' data-base='USD' data-ticker='true' data-rank='true' data-marketcap='true' data-volume='true' data-statsticker='false' />
            </div>
...
function FooterSectionSocial (): JSX.Element {
  ...
  return (
    <FooterSection heading={t('footer.social.title')}>
      ...
      />
      <FooterExternalLink
        text={`${t('footer.social.telegram')} (ES)`} url='https://t.me/official_defichain_es'
      ...
      />
      <FooterExternalLink
        text={`${t('footer.social.telegram')} (RU)`} url='https://t.me/defichain_ru'
