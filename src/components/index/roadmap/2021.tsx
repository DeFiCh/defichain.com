...
export function TimeLine2021 (): JSX.Element {
  ...
  const cards: any[] = t('RoadmapSection.2021.cards', { returnObjects: true })

  return (
    <TimeLineContainer testid='RoadmapSection.2021' timeline={t('RoadmapSection.2021.title')} label={t('RoadmapSection.2021.status')}>
      <Slider {...settings}>
        {
          cards.map(card => {
            return (
