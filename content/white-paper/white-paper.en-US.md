...
---
  ...
  <h2
      ...
      title="Abstract"
      className=
        "text-[24px] leading-8 scroll-mt-40 lg:text-[32px] lg:leading-[40px]"
    >
      1.Abstract
    </h2>
...
<div className="mt-12 font-bold lg:text-2xl">This Document is not a Prospectus</div>
...
<div className="mt-12 font-bold lg:text-2xl">
...
<h2 id="Executive Summary"
      ...
      className=
        "text-[24px] leading-8 scroll-mt-40 mt-12 lg:text-[32px] lg:leading-[40px]">
        2.Executive summary
</h2>
...
<h3 id="the-problem" title="The Problem" className="mt-12 font-bold lg:text-2xl">
The Problem
</h3>
<div className="mt-5 text-dark-800 text-base leading-7">
...
<h3 id="the-solution" title="The Solution" className="mt-12 font-bold lg:text-2xl">
The Solution
</h3>
</div>
<div className="mt-5 text-dark-800">
...
<ul style="list-style:disc; display:grid; grid-template-rows: repeat(3, minmax(0, 1fr));
...
<h3 id="timeline" title="Timeline" className="mt-12 font-bold lg:text-2xl">
The Timeline
</h3>
<div className="mt-5">
...
<h2 id="Background"
  title="Background"
  className="text-[24px] leading-8 scroll-mt-40 mt-12 lg:text-[32px] lg:leading-[40px]">
  3.Background/Industry
</h2>

<h3 id="promises" title="DeFi’s promises and challenges" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="stateOfDefi" title="The state of DeFi" className="mt-12 font-bold lg:text-2xl">
The state of DeFi
</h3>
<div className="mt-5 text-dark-800">
...
<h3 id="currentProblems" title="DeFi’s current problems" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="consequences" title="Consequences in the DeFi Market" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="bitcoinWhyNot" title="Bitcoin: Why not?" className="mt-12 font-bold lg:text-2xl">
Bitcoin: Why Not?
</h3>
<div className="mt-5 text-dark-800">
...
<h3 id="turingComplete" title="Turing-complete solutions" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="ecosystem" title="Staying in the Bitcoin Ecosystem" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="building" title="Building on Top of Bitcoin" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="benefits" title="Benefits of DeFiChain" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="dAppSets" title="Initial dAppSets" className="mt-12 font-bold lg:text-2xl">
Initial dAppSets
</h3>
<div className="mt-4 text-dark-800">
  <ul class="list-inside list-disc" style="list-style-position: inside;">
...
<h3 id="lending" title="Decentralized Lending" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="tokenWrapping" title="Decentralized Wrapping of Tokens" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="pricingOracles" title="Decentralized Pricing Oracles" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="dex" title="Decentralized Exchanges" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="transferrableDebts" title="Transferable Debts and Receivables" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="noncollateralizedDebt" title="Decentralized Non-Collateralized Debt" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="assetTokenization" title="Asset Tokenization" className="mt-12 font-bold lg:text-2xl">
Asset Tokenization
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="dividendsDist" title="Distribution of Dividends" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="param" title="Design Parameters" className="mt-12 font-bold lg:text-2xl">
Design Parameters
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="consensus" title="Consensus Algorithm" className="mt-12 font-bold lg:text-2xl">
Consensus Algorithm
</h3>
...
<h3 id="bitcoinAnchoring" title="Bitcoin Anchoring" className="mt-12 font-bold lg:text-2xl">
Bitcoin Anchoring
</h3>
...
<h3 id="dst" title="Tokenization as a DeFi Standard Token (DST)" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="crossChain" title="Cross-chain Mechanics" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="dct" title="DeFi Custom Token (DCT)" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="dat" title="DeFi Asset Token (DAT)" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="economicPegging" title="Economic Pegging of DATs" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="loanContract" title="Loan Contract" className="mt-12 font-bold lg:text-2xl">
Loan Contract
</h3>
<div className="mt-5 text-dark-800">
...
<h3 id="dex" title="Decentralized Exchange (DEX)" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="xcx" title="Cross-chain Exchange (XCX)" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="pricingOracles" title="Pricing Oracles" className="mt-12 font-bold lg:text-2xl">
Pricing Oracles
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="useCases" title="Use Case Examples" className="mt-12 font-bold lg:text-2xl">
Use Case Examples
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="utility" title="$DFI coin Utility" className="mt-12 font-bold lg:text-2xl">
$DFI coin Utility
...
<h3 id="masternodes" title="Masternodes" className="mt-12 font-bold lg:text-2xl">
Masternodes
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="governance" title="Governance" className="mt-12 font-bold lg:text-2xl">
Governance
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="cdf" title="Community Development Fund" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="initialToken" title="Initial Token Distribution" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="tokenIssuance" title="Token Issuance Schedule" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="acquiringDFI" title="Acquiring $DFI coins" className="mt-12 font-bold lg:text-2xl">
Acquiring $DFI coins
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="targetMarket" title="Target Market" className="mt-12 font-bold lg:text-2xl">
Target Market
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="goToMarketStrat" title="Go-to-market Strategy" className="mt-12 font-bold lg:text-2xl">
...
<h3 id="partnership" title="Partnerships" className="mt-12 font-bold lg:text-2xl">
Partnerships
</h3>
<div className="mt-4 text-dark-800">
...
<h3 id="future" title="A Glimpse into the Future" className="mt-12 font-bold lg:text-2xl">
