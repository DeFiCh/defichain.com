...
Open the downloaded image **DeFi-<version>.dmg**. In the Finder window that pops up, drag the DeFi on the left, on to the Applications directory shortcut on the right.
