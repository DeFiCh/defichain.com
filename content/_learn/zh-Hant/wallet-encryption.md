...
3. 在控制台上輸入以下內容來鎖定您的錢包：
   ...
   在這階段您的遞飛鏈桌面版錢包應用程序處在僅查的狀態但能正常運作流動性挖礦。如果您試圖發送DFI或DST，程序會顯示有失誤: `Add-on auth TX failed: Can't sign TX`
...
3. 入門指南裏的步驟會依遞飛鏈桌面版錢包應用程序版本更新。具有最高安全標准的Ledger硬件錢包已在開發中，請拭目以待。
