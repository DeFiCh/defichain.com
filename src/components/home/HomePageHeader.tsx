...
export function HomePageHeader (): JSX.Element {
  return (
    ...
    >
      <Container className='h-full mt-36 mb-16 min-h-[35rem] lg:min-h-[40rem]'>
        <div className='mx-auto w-full md:w-1/2'>
          ...
          <div className='h-full flex flex-wrap items-center'>
            <div className='mt-10 flex flex-wrap'>
              <div className='w-full text-lg md:text-2xl text-gray-900 text-center' data-testid='Header.desc.main'>A blockchain dedicated to fast, intelligent and transparent decentralized financial services, accessible by everyone.
              </div>
              <br />
            </div>
          </div>
