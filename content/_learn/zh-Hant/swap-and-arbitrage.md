...
啓動遞飛鏈桌面版錢包應用程序後，請按側邊攔的 **餘額** 選項。先確認您有沒有足夠的DFI，交易中必要用的。若還沒購買DFI，請查看[入門購買DFI](https://defichain.ghost.io/where-and-how-to-buy-dfi-defichain/)。
...
[按下載遞飛鏈桌面版錢包應用程序](/downloads)，適用于Windows，macOS和Linux。您也可成為套利者。
