...
function StatsItem({
  ...
  return (
    <div className="flex lg:flex-col flex-row items-center gap-y-2">
      ...
      <div className="text-dark-1000 lg:text-[52px] text-xl leading-6 lg:leading-[52px] lg:grow-0 grow text-right">
        {prefix ?? ""}
        <CountUp
      ...
      <div className=" hidden lg:block text-dark-700">{desc}</div>
    </div>
  );
}
