...
Open the downloaded image **DeFi-Wallet-XX.dmg**. In the Finder window that pops up, drag the DeFi Wallet on the left, on to the Applications directory shortcut on the right.

<p><img src="./img/drag-to-install.png" /></p>
